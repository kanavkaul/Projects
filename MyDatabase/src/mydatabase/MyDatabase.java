...
public class MyDatabase {
    ...
    private static final String idIndFile = "id.ndx";
    private static final String companyIndFile = "company.ndx";
    private static final String drug_idIndFile = "drugid.ndx";
    private static final String trialsIndFile = "trials.ndx";
    private static final String patientsIndFile = "patients.ndx";
    private static final String dosage_mgIndFile = "dosage_mg.ndx";
    private static final String readingIndFile = "reading.ndx";
    private static final String double_blindIndFile = "double_blind.ndx";
    private static final String controlled_studyIndFile = "controlled_study.ndx";
    private static final String govt_fundedIndFile = "govt_funded.ndx";
    private static final String fda_approvedIndFile = "fda_approved.ndx";
...
public static void main(String args[]) throws IOException{
        ...
        System.out.println("Do you want to parse the input csv file to binary?");
        ...
        CsvReader reader = new CsvReader("PHARMA_TRIALS_1000B.csv");
        ArrayList<Long> companyList;
        RandomAccessFile file = new RandomAccessFile("Data.db","rw");

        if (flag){
            System.out.println("Please wait while the index file are being created...");
            reader.readHeaders();
            while (reader.readRecord())
            {
                ...
                udpatecompanyIndexFile(companyIndFile);
                ...
                udpatedrug_idIndexFile(drug_idIndFile);
        ...
        System.out.println("Please select a field for querying ");
        String input3 = scanner.nextLine();
        if(!flag){
            System.out.println("Please convert the csv file into binary first");
        }
        else{
        ...
        switch(input3){
            ...
            case "drug_id" :
                System.out.println("Enter drug_id to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
                ...
                break;
            case "trials" :
                System.out.println("Enter trials to be searched ");
                input1 = scanner.nextLine();
                System.out.println("enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
                ...
                break;
            case "patients" :
                System.out.println("Enter patient to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
            ...
            case "company" :
                ...
                break;
            case "double_blind" :
                System.out.println("Enter double_blind value to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
            ...
            case "dosage_mg" :
                System.out.println("Enter dosage_mg value to be searched");
            ...
            case "reading" :
                System.out.println("Enter reading value to be searched");
            ...
            case "controlled_study" :
                System.out.println("Enter controlled_study value to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
            ...
            case "govt_funded" :
                System.out.println("Enter govt_funded value to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
            ...
            case "fda_approved" :
                System.out.println("Enter fda_approved value to be searched");
                input1 = scanner.nextLine();
                System.out.println("Enter comparison operator ");
                input2 = scanner.nextLine();
                System.out.println("---------------------------------");
